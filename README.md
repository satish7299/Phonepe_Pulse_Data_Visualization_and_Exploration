...
def map_user_plot_1(df, year):
    ...
    fig_line_1= px.line(muyg, x= "States", y= ["RegisteredUsers", "AppOpens"],
                        title= f"{year} REGISTEREDS USER, APPOPENS",width= 1000, height= 800, markers= True)
    st.plotly_chart(fig_line_1)
...
def map_user_plot_3(df, states):
    ...
    with col1:
        fig_map_user_bar_1= px.bar(muyqs, x= "RegisteredUsers", y= "Districts", orientation= "h",
                                title= f"{states.upper()} REGISTEREDS USER", height= 800, color_discrete_sequence= px.colors.sequential.Rainbow_r)
...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\e-Orchids-LenovoG50\Downloads\image.png"),width= 600)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\e-Orchids-LenovoG50\Downloads\phone.png"),width=600)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\e-Orchids-LenovoG50\Downloads\pay.png"),width= 600)
     ...
     with tab1:
         ...
         if method == "Insurance Analysis":
            ...
            Transaction_amount_count_Y_Q(Aggre_tran_tac_Y, quarters)
